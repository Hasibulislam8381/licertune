@extends('backend.app')
@section('title', 'BrandCamp Sections')
...
@push('script')
    <script>
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#data-table')) {
                let dTable = $('#data-table').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('backend.brand_camp.index') }}",
                        type: "get",
                    },
                    columns: [{
                            data: 'DT_RowIndex',
        ...
        function statusChange(id) {
            let url = '{{ route('backend.brand_camp.status', ':id') }}';
            $.ajax({
                type: "GET",
        ...
        function deleteItem(id) {
            let url = '{{ route('backend.brand_camp.destroy', ':id') }}';
            $.ajax({
                type: "DELETE",
                url: url.replace(':id', id),
                headers: {
