                ...
                <div class="p-3 card">
                    <div class="card-style mb-30">
                        <div class="mb-4 d-flex justify-content-start">
                            <a href="{{ route('backend.our_team.create') }}" class="btn btn-primary btn-lg">Add New
                                Member</a>
                        </div>
...
@push('script')
    <script>
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#data-table')) {
                let dTable = $('#data-table').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('backend.our_team.index') }}",
                        type: "get",
                    },
                    columns: [{
                            data: 'DT_RowIndex',
        ...
        function statusChange(id) {
            let url = '{{ route('backend.our_team.status', ':id') }}';
            $.ajax({
                type: "GET",
        ...
        function deleteItem(id) {
            let url = '{{ route('backend.our_team.destroy', ':id') }}';
            $.ajax({
                type: "DELETE",
                url: url.replace(':id', id),
                headers: {
