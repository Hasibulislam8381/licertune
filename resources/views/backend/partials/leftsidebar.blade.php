    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <!-- Future Features -->
                <li class="{{ request()->routeIs(['backend.future_features.*']) ? 'mm-active' : '' }}">
                    <a href="{{ route('backend.future_features.index') }}" class="waves-effect" style="color: #000">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="icon icon-tabler icon-tabler-rocket">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path d="M12 2l2 7l7 2l-7 2l-2 7l-2-7l-7-2l7-2z" />
                        </svg>
                        <span key="t-future-features">Future Features</span>
                    </a>
                </li>
